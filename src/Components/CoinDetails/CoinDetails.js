                    ...
                    (<div className='px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2'>
                        <div className='h-full grid grid-cols-1 md:grid-cols-2 justify-items-center gap-4 md:justify-items-around content-center'>
                            <div className='order-2 md:order-1'>
                                <h1 className='text-3xl mb-2'>General Info:</h1>
                                <hr className='mb-2' />
                                ...
                                <h1>Contact Address: {' '} {coin.contract_address ? coin.contract_address : 'Not Available'}</h1>
                                <h1>Hashing Algorithm: {' '} {coin.hashing_algorithm ? coin.hashing_algorithm : 'Not Available'}</h1>
                                <h1>Genesis Date: {' '} {coin.genesis_date ? coin.genesis_date : 'Not Available'}</h1>
